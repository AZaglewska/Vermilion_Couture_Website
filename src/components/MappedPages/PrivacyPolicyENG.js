...
const PrivacyPolicyENG = () => {
  return (
    <PrivacyPolicyContent>
      ...
      <PrivacyPolicyList>
        <PrivacyPolicyListMain>
          <p first>Interpretation and Definitions</p>
          <PrivacyPolicyNested>
            <li>
              Interpretation
              <ul>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  ...
                  "Us" or "Our" in this Agreement) refers to Vermilion Couture
                  Katarzyna Borychowska, Chełmska 6/8 m 1 , 00-725 Warszawa.
                </li>
                <li>
        ...
        <PrivacyPolicyListMain>
          ...
          <PrivacyPolicyNested>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  ...
                  here: All About Cookies by TermsFeed. We use both Session and
                  Persistent Cookies for the purposes set out below:
                </li>
                <li>
                  <b>Necessary / Essential Cookies</b> Type: Session Cookies
                ...
                <li>
                  <b>Cookies Policy / Notice Acceptance Cookies</b> Type:
                ...
                <li>
                  ...
                  re-enter your preferences every time You use the Website. For
            ...
            <li>
              ...
              <ul>
                <li>
                  ...
                  agreements and policies. The Company will also retain Usage
            ...
            <li>
              ...
              <ul>
                <li>
                  <b>Business Transactions</b>. If the Company is involved in a
                ...
                <li>
                  <b>Law enforcement</b>. Under certain circumstances, the
                  Company may be required to disclose Your Personal Data if
                  required to do so by law or in response to valid requests by
                  public authorities (e.g. a court or a government agency).
                </li>
                <li>
                  <b>Other legal requirements</b>. The Company may disclose Your
